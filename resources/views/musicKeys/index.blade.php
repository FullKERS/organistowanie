...
@section('content')
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-10"><h3 class="card-title">Lista tonacji</h3></div>
                <div class="col-2 text-right">
                    <a href="{{route('musicKey.create')}}" class="btn">
        ...
        <div class="card-body">
            ...
            @php
                $heads = ['ID', 'Tonacja', 'Transpozycja', ['label' => 'Akcje', 'no-export' => true, 'width' => 5]];
            ...
            <x-adminlte-datatable id="table1" :heads="$heads">
                @foreach ($config['data'] as $row)
                    <tr>
                        <td>{!! $row['id'] !!}</td>
                        <td>{!! $row['name'] !!}</td>
                        <td>{!! $row['transpositionDown'] !!} / {!! $row['transpositionUp']!!}</td>
